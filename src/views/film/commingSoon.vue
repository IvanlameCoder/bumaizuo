...
export default {
  ...
  mounted() {
    ...
    http({
      url: `/gateway?cityId=${this.cityId}&pageNum=1&pageSize=10&type=2&k=9838824`,
      headers: {
    ...
    // axios({
    //     url:`https://m.maizuo.com/gateway?cityId=${this.cityId}&pageNum=1&pageSize=10&type=2&k=9838824`,
    //     headers:{
